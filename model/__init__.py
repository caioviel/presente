...
class AnnotationProject(object):
    def __init__(self, mid, name, main_media=None, description=None, last_modification=None, username=None, directory=None, secondary_media=None):
        self.id = mid
        self.name = name
        self.main_media = main_media
        self.secondary_media = secondary_media
    ...
    def parse_json(json_object, directory=None):
        project =  AnnotationProject(json_object['AnnotationProject']['id'],
                                         ...
                                         json_object['AnnotationProject']['secondary_media'])
    ...
    def to_json(self):
        ...
        json_object = {'AnnotationProject' : {
                                              ...
                                              "secondary_media" : self.secondary_media,
